var articles = [
    ...
    {
        id: '3cpy',
        title: 'Президент Грузии пригласил Лукашенко в Тбилиси Президент Грузии пригласил Лукашенко в Тбилиси Президент Грузии пригласил Лукашенко в Тбилиси',
        summary: 'Президент Грузии Георгий Маргвелашвили пригласил президента Беларуси Александра Лукашенко совершить визит в Тбилиси. Об этом сообщает пресс-служба президента Грузии.',
        createdAt: new Date('2017-03-02T17:21:25'),
        author: 'Виталий Шидлов',
        content: 'Сегодня, 2 марта, в Минске состоялась еще одна встреча президентов двух стран.«Президенты сегодня подвели итоги визита Георгия Маргвелашвили в Минск и обсудили пути реализации достигнутых договоренностей. Президент Грузии пригласил президента Беларуси совершить визит в Тбилиси», — говорится в заявлении пресс-службы грузинского лидера.Там также сообщили, что накануне двусторонняя встреча президентов Беларуси и Грузии продолжалась более трех часов. Дата визита Лукашенко будет согласована позднее. Это будет второй визит президента Беларуси в Грузию. Первый раз в этой стране Александр Лукашенко побывал в апреле 2015 года.'
    ...
    },
    {
        id: '7cpy',
        title: '"Белэкспо" будет в Курасовщине, от Ноттингема еще не отказались, экс-Кемпински введут',
        summary: 'На пресс-конференции в Мингорисполкоме чиновники рассказали о крупных стройках, которые город сейчас ведет или планирует начать. На пресс-конференции в Мингорисполкоме чиновники рассказали о крупных стройках, которые город сейчас ведет или планирует начать.',
        createdAt: new Date('2017-03-02T19:38:59'),
        author: 'Антон Тарлецкий',
        content: '— Снос 2-й больницы завершится в ноябре-декабре, — рассказал зампред Мингорисполкома Виктор Лаптев. — Что касается иных площадок для "Белэкспо", то мы раньше уже подбирали участок для строительства, сейчас вопрос только в финансировании. Если участок будет одобрен, то "Белэкспо" будем строить в районе улиц Корженевского - Кижеватова, есть и проектная документация по этому объекту. Вопрос схемы финансирования и привлечения инвесторов сейчас активно обсуждается. Но сказать, что участок определен конкретно, нельзя: это вопрос не только города, но и республиканских органов. Работа ведется.',
        tags: []
    ...
    },
    {
        ...
        createdAt: new Date('2017-03-02T23:16:48'),
        author: 'Виталий Шидлов',
...
function removeArticle(id) {
    for (var i = 0; i < numOfArticles; i++)
        if (articles[i].id === id) {
            numOfArticles--;
            return articles.splice(i, 1);
        }
}

        console.log("Now there are " + numOfArticles + " articles");
        console.log("Checking for invalid articles:");
        for (var i = 0; i < numOfArticles; i++) {
            if (!validateArticle(articles[i])) {
                console.log("Article with id: " + articles[i].id + " is INVALID (Removing...)");
                removeArticle(articles[i].id);
            }
        }
        console.log("Now there are " + numOfArticles + " articles");
        console.log("The article with id '5':");
        console.log(getArticle('5'));
        console.log("Trying to edit it...");
        if (editArticle('5', {title: '1234567890123456789012345678901234567890123456789012345678901234567890123456789012345678901234567890 ',
                              summary: 'Это новость про числа!',
                                content: '123456123456123456123456123456123456'}))
            console.log("Edited succesfully!");
        else
            console.log("Incorrect attempt!");
        if (editArticle('5', {title: '1234567890 ',
                summary: 'Это новость про числа!',
                content: '123456123456123456123456123456123456'}))
            console.log("Edited succesfully!");
        else
            console.log("Incorrect attempt!");
        console.log(getArticle('5'));
        console.log("Now lets add new article:");
        addArticle(
            {
                id: '2500n',
                title: 'Что-то новенькое...',
                summary: 'Пытаемся добавить новость',
                author: 'Кто-то по имени...',
                content: 'Добавление новой новости',
                tags: ['NOVIYTAG']
            }
        );
        console.log(getArticle('2500n'));
        console.log("Now the most interesting part:");
        console.log("GetArticles(3, 6):");
        console.log(getArticles(3, 6));
        console.log("Author: 'Иван Иванов'");
        console.log(getArticles(0, 2, {author: 'Иван Иванов'}));
        console.log("From 2017-03-02 20:00:00 to 2017-03-03 23:00:00");
        getArticles(0, 10, {createdAtFrom: new Date('2017-03-02T20:00:00'), createdAtTo: new Date('2017-03-03T23:00:00')}).forEach(
            function (item, i, arr) {
        ...
        console.log(articles[0].tags.length);
        ...
        console.log("Some news about Minsk:");
        console.log(getArticles(0, 10, {tags: ['Минск']}));
